...
public class MessagesConfig {
    ...
    public String getMessage(String key, String player, int vl, double buffer) {
    ...
    public String getMessage(String key, String player, double probability, String prob_colored, double buffer, int vl) {
        String msg = getMessage(key);
        String playerValue = player != null ? player : "";
        String probValue = String.format("%.4f", probability);
        String bufferValue = String.format("%.1f", buffer);
